...
class DevotionalService:
    ...
    def get_for_emotion(cls, emotion_slug: str, user) -> Dict[str, Any]:
        ...
        return {
            ...
            "anchor_text": getattr(chosen_content, 'anchor_text', ''),
            "carry_with_you_text": getattr(chosen_content, 'carry_with_you_text', ''),
            "word_continues_text": getattr(chosen_content, 'word_continues_text', ''),
